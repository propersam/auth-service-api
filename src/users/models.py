...
class UserProfile(AbstractBaseUser, PermissionsMixin):
	...
	firstName = models.CharField('User First Name', max_length=50, blank=True)
	lastName = models.CharField('User Last Name', max_length=50, blank=True)
	username = models.CharField("User's login username", max_length=50)
	email = models.EmailField("User Email", max_length=125, unique=True, null=False)
	organisation = models.ForeignKey(Organisation, related_name='user_organisation', on_delete=models.CASCADE, blank=True, null=True)
	roles = models.ManyToManyField(Role, related_name='user', blank=True)
	...
	gender = models.CharField("User's Gender", max_length=5, choices=GENDER_CHOICES, default='m', blank=True)
